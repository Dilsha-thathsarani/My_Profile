        ...
        <div className="container">
          <div className="home__content">
            <div className="home__meta">
              ...
              <h2 className="home__text pz__10">I’m Dilsha Thathsarani</h2>
              ...
              <a href="https://wa.me/94702425560?text=">
                <img
                  style={{ marginLeft: 20 }}
                  src={logo2}
                  alt=""
              ...
              <a href="http://www.linkedin.com/in/dilsha-thathsarani-574638217">
                <img
                  style={{ marginLeft: 20 }}
                  src={logo3}
                  alt=""
              ...
              <a href="https://www.instagram.com/dilsha_th/">
                <img
                  style={{ marginLeft: 20 }}
                  src={logo5}
                  alt=""
              ...
              <a href="mailto:dilsha99t@gmail.com">
                <img
                  style={{ marginLeft: 20 }}
                  src={logo1}
                  alt=""
